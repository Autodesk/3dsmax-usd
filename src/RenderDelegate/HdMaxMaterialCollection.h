...
public:
    ...
    /**
     * Returns a material suitable for gizmos for the given render node.
     * @param renderNode The 3dsMax render node.
     * @param selected Whether the gizmo is selected or not.
     * @return The gizmo material.
     */
    static MaxSDK::Graphics::BaseMaterialHandle
    GetGizmoMaterial(const MaxSDK::Graphics::RenderNodeHandle& renderNode, bool selected);
...
private:
    ...
    BitmapCache bitmapCache;
    /// A material to be used for drawing selected gizmos in the viewport.
