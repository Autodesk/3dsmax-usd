...
MaxSDK::Graphics::HLSLMaterialHandle HdMaxMaterialCollection::gizmoMtlSelected;
...
MaxSDK::Graphics::BaseMaterialHandle HdMaxMaterialCollection::GetGizmoMaterial(
