...
class MaxUsdHelperWriter : public MaxUsdPrimWriter
{
public:
    static ContextSupport CanExport(INode* node, const MaxUsd::USDSceneBuilderOptions& exportArgs);

    MaxUsdHelperWriter(const MaxUsdWriteJobContext& jobCtx, INode* node);
    ...
    WStr GetWriterName() override { return L"Helper writer"; };
};
