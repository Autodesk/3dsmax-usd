...
#define USD_COMPONENT_VERSION \
    MAKE_VERSION_NUMBER(      \
        COMPONENT_VERSION_MAJOR, COMPONENT_VERSION_MINOR, COMPONENT_VERSION_MICRO, VERSION_INT)
#define USD_COMPONENT_VERSION_STRING MAKE_VERSION_STRING(USD_COMPONENT_VERSION)
#define USD_COMPONENT_VERSION_COMMA_SEPARATED \
    MAKE_VERSION_NUMBER_COMMA_SEPARATED(      \
        COMPONENT_VERSION_MAJOR, COMPONENT_VERSION_MINOR, COMPONENT_VERSION_MICRO, VERSION_INT)
