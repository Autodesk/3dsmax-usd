...
{
    Q_OBJECT
    Q_PROPERTY(QString mappingFilePath READ mappingFilePath WRITE setMappingFilePath NOTIFY mappingFilePathChanged)
    Q_PROPERTY(bool includeProjectTokens READ includeProjectTokens WRITE setIncludeProjectTokens NOTIFY includeProjectTokensChanged)
    Q_PROPERTY(bool userPathsFirst READ userPathsFirst WRITE setUserPathsFirst NOTIFY userPathsFirstChanged)
    Q_PROPERTY(bool userPathsOnly READ userPathsOnly WRITE setUserPathsOnly NOTIFY userPathsOnlyChanged)
    Q_PROPERTY(QStringList extAndEnvPaths READ extAndEnvPaths WRITE setExtAndEnvPaths NOTIFY extAndEnvPathsChanged)
