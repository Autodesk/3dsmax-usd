...
void HeaderWidget::paintEvent(QPaintEvent* event)
{
    ...
    using _QStyleOptionHeader = QStyleOptionHeaderV2;
#else
    using _QStyleOptionHeader = QStyleOptionHeader;
#endif
    _QStyleOptionHeader opt;
    opt.initFrom(this);

    opt.position = _QStyleOptionHeader::SectionPosition::Middle;
