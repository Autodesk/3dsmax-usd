...
class MaxUsd_FallbackPrimReader : public MaxUsdPrimReader
{
public:
    MaxUsd_FallbackPrimReader(const UsdPrim& prim, MaxUsdReadJobContext& jobCtx);

    bool Read() override;

    static MaxUsdPrimReaderRegistry::ReaderFactoryFn CreateFactory();
};
