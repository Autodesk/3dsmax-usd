...
class TestMaxSceneBuilderOptions(unittest.TestCase):
    ...
    def test_options(self):
        ...
        self.assertEqual(2, len(options.GetShadingModes()))
        self.assertEqual('useRegistry', options.GetShadingModes()[1]['mode'])
        self.assertEqual('UsdPreviewSurface', options.GetShadingModes()[1]['materialConversion'])
        self.assertEqual('useRegistry', options.GetShadingModes()[0]['mode'])
        self.assertEqual('MaterialXReference', options.GetShadingModes()[0]['materialConversion'])
