...
TEST(ViewportDisplayOptions, MaterialAndPerformance)
{
	...
	displaySettings.SetDisplayMode(HdMaxDisplaySettings::USDPreviewSurface, testEngine.GetChangeTracker());
	...
	displaySettings.SetDisplayMode(HdMaxDisplaySettings::USDDisplayColor, testEngine.GetChangeTracker());
	TestRender(stage, testEngine, renderItems, 0, multiMat);
