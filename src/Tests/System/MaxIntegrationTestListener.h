...
class MaxIntegrationTestListener : public testing::TestEventListener
{
public:
    MaxIntegrationTestListener();
    virtual ~MaxIntegrationTestListener();
...
protected:
    void MaxAssertTrue(bool val, const TCHAR* msg);
};