...
TEST(Consolidation, Consolidate2Boxes)
{
    ...
    std::array<Point3, 48> expectedPoints
        = { Point3(-14.170527, -4.749669, 0.000000), Point3(-14.170527, 7.248690, 0.000000),
            Point3(-2.054874, 7.248690, 0.000000),   Point3(-2.054874, -4.749669, 0.000000),
            Point3(-14.170527, -4.749669, 7.272934), Point3(-2.054874, -4.749669, 7.272934),
            Point3(-2.054874, 7.248690, 7.272934),   Point3(-14.170527, 7.248690, 7.272934),
            Point3(-14.170527, -4.749669, 0.000000), Point3(-2.054874, -4.749669, 0.000000),
            Point3(-2.054874, -4.749669, 7.272934),  Point3(-14.170527, -4.749669, 7.272934),
            Point3(-2.054874, -4.749669, 0.000000),  Point3(-2.054874, 7.248690, 0.000000),
            Point3(-2.054874, 7.248690, 7.272934),   Point3(-2.054874, -4.749669, 7.272934),
            Point3(-2.054874, 7.248690, 0.000000),   Point3(-14.170527, 7.248690, 0.000000),
            Point3(-14.170527, 7.248690, 7.272934),  Point3(-2.054874, 7.248690, 7.272934),
            Point3(-14.170527, 7.248690, 0.000000),  Point3(-14.170527, -4.749669, 0.000000),
            Point3(-14.170527, -4.749669, 7.272934), Point3(-14.170527, 7.248690, 7.272934),
            Point3(5.431611, -3.848971, 6.535490),   Point3(0.924379, 6.347991, 2.100668),
            Point3(9.421789, 6.347991, -6.535490),   Point3(13.929021, -3.848971, -2.100668),
            Point3(9.837482, -0.016105, 10.870581),  Point3(18.334892, -0.016105, 2.234422),
            Point3(13.827660, 10.180856, -2.200399), Point3(5.330250, 10.180856, 6.435759),
            Point3(5.431611, -3.848971, 6.535490),   Point3(13.929021, -3.848971, -2.100668),
            Point3(18.334892, -0.016105, 2.234422),  Point3(9.837482, -0.016105, 10.870581),
            Point3(13.929021, -3.848971, -2.100668), Point3(9.421789, 6.347991, -6.535490),
            Point3(13.827660, 10.180856, -2.200399), Point3(18.334892, -0.016105, 2.234422),
            Point3(9.421789, 6.347991, -6.535490),   Point3(0.924379, 6.347991, 2.100668),
            Point3(5.330250, 10.180856, 6.435759),   Point3(13.827660, 10.180856, -2.200399),
            Point3(0.924379, 6.347991, 2.100668),    Point3(5.431611, -3.848971, 6.535490),
            Point3(9.837482, -0.016105, 10.870581),  Point3(5.330250, 10.180856, 6.435759) };
    ...
    EXPECT_TRUE(Point3ArraysAreAlmostEqual(
        expectedPoints.data(),
        static_cast<int>(expectedPoints.size()),
        pointsData,
    ...
    std::array<Point3, 48> expectedNormals
        = { Point3(0.000000, 0.000000, -1.000000),   Point3(0.000000, 0.000000, -1.000000),
            ...
            Point3(-0.701358, 0.000000, 0.712810),   Point3(-0.701358, 0.000000, 0.712810) };
    EXPECT_TRUE(Point3ArraysAreAlmostEqual(
        expectedNormals.data(),
        static_cast<int>(expectedNormals.size()),
        normalsData,
    ...
    std::array<Point3, 48> expectedUvs
        = { Point3(1.000000, 1.000000, 0.000000), Point3(1.000000, 0.000000, 0.000000),
            ...
            Point3(1.000000, 0.000000, 0.000000), Point3(0.000000, 0.000000, 0.000000) };
    const auto uvsData
        = reinterpret_cast<Point3*>(uvsBuffer.Lock(0, 0, MaxSDK::Graphics::ReadAcess));
    EXPECT_TRUE(Point3ArraysAreAlmostEqual(
        expectedUvs.data(),
        static_cast<int>(expectedUvs.size()),
        uvsData,
        static_cast<int>(uvsBuffer.GetNumberOfVertices())));
    ...
    std::array<int, 72> expectedIndices
    ...
    const auto indicesData
        = reinterpret_cast<int*>(trianglesIndexBuffer.Lock(0, 0, MaxSDK::Graphics::ReadAcess));
    ...
    std::array<int, 96> wireframeExpectedIndices
        = { 0,  1,  1,  2,  2,  3,  3,  0,  4,  5,  5,  6,  6,  7,  7,  4,  8,  9,  9,  10,
            10, 11, 11, 8,  12, 13, 13, 14, 14, 15, 15, 12, 16, 17, 17, 18, 18, 19, 19, 16,
            20, 21, 21, 22, 22, 23, 23, 20, 24, 25, 25, 26, 26, 27, 27, 24, 28, 29, 29, 30,
            30, 31, 31, 28, 32, 33, 33, 34, 34, 35, 35, 32, 36, 37, 37, 38, 38, 39, 39, 36,
            40, 41, 41, 42, 42, 43, 43, 40, 44, 45, 45, 46, 46, 47, 47, 44 };
    EXPECT_TRUE(std::equal(
        wireframeExpectedIndices.begin(), wireframeExpectedIndices.end(), wireframeIndicesData));
}
...
TEST(Consolidation, ConsolidateInstances)
{
    ...
    std::array<Point3, 48> expectedPoints
        = { Point3(0.168677, -0.483523, 7.066816),    Point3(0.168677, 6.583293, -0.000000),
            Point3(-6.898139, -0.483524, -0.000000),  Point3(0.168677, -0.483523, 7.066816),
            Point3(-6.898139, -0.483524, -0.000000),  Point3(0.168677, -7.550339, -0.000000),
            Point3(0.168677, -0.483523, 7.066816),    Point3(0.168677, -7.550339, -0.000000),
            Point3(7.235493, -0.483522, -0.000000),   Point3(0.168677, -0.483523, 7.066816),
            Point3(7.235493, -0.483522, -0.000000),   Point3(0.168677, 6.583293, -0.000000),
            Point3(-21.048500, -0.483523, 7.066816),  Point3(-21.048500, 6.583293, -0.000000),
            Point3(-28.115316, -0.483524, -0.000000), Point3(-21.048500, -0.483523, 7.066816),
            Point3(-28.115316, -0.483524, -0.000000), Point3(-21.048500, -7.550339, -0.000000),
            Point3(-21.048500, -0.483523, 7.066816),  Point3(-21.048500, -7.550339, -0.000000),
            Point3(-13.981684, -0.483522, -0.000000), Point3(-21.048500, -0.483523, 7.066816),
            Point3(-13.981684, -0.483522, -0.000000), Point3(-21.048500, 6.583293, -0.000000),
            Point3(19.769899, -0.483523, 7.066816),   Point3(19.769899, 6.583293, -0.000000),
            Point3(12.703083, -0.483524, -0.000000),  Point3(19.769899, -0.483523, 7.066816),
            Point3(12.703083, -0.483524, -0.000000),  Point3(19.769899, -7.550339, -0.000000),
            Point3(19.769899, -0.483523, 7.066816),   Point3(19.769899, -7.550339, -0.000000),
            Point3(26.836716, -0.483522, -0.000000),  Point3(19.769899, -0.483523, 7.066816),
            Point3(26.836716, -0.483522, -0.000000),  Point3(19.769899, 6.583293, -0.000000),
            Point3(-0.122053, 18.332500, 7.066816),   Point3(-0.122053, 25.399317, -0.000000),
            Point3(-7.188869, 18.332500, -0.000000),  Point3(-0.122053, 18.332500, 7.066816),
            Point3(-7.188869, 18.332500, -0.000000),  Point3(-0.122053, 11.265684, -0.000000),
            Point3(-0.122053, 18.332500, 7.066816),   Point3(-0.122053, 11.265684, -0.000000),
            Point3(6.944763, 18.332502, -0.000000),   Point3(-0.122053, 18.332500, 7.066816),
            Point3(6.944763, 18.332502, -0.000000),   Point3(-0.122053, 25.399317, -0.000000) };
    ...
    std::array<Point3, 48> expectedNormals
        = { Point3(0.000000, -0.000000, 1.000000),  Point3(-0.000000, 0.707107, 0.707107),
            Point3(-0.707107, -0.000000, 0.707107), Point3(0.000000, -0.000000, 1.000000),
            Point3(-0.707107, -0.000000, 0.707107), Point3(0.000000, -0.707107, 0.707107),
            Point3(0.000000, -0.000000, 1.000000),  Point3(0.000000, -0.707107, 0.707107),
            Point3(0.707107, 0.000000, 0.707107),   Point3(0.000000, -0.000000, 1.000000),
            Point3(0.707107, 0.000000, 0.707107),   Point3(-0.000000, 0.707107, 0.707107),
            Point3(0.000000, -0.000000, 1.000000),  Point3(-0.000000, 0.707107, 0.707107),
    ...
    std::array<int, 48> expectedIndices
    ...
    std::array<int, 96> wireframeExpectedIndices
        = { 0,  1,  1,  2,  2,  0,  3,  4,  4,  5,  5,  3,  6,  7,  7,  8,  8,  6,  9,  10,
            10, 11, 11, 9,  12, 13, 13, 14, 14, 12, 15, 16, 16, 17, 17, 15, 18, 19, 19, 20,
            20, 18, 21, 22, 22, 23, 23, 21, 24, 25, 25, 26, 26, 24, 27, 28, 28, 29, 29, 27,
            30, 31, 31, 32, 32, 30, 33, 34, 34, 35, 35, 33, 36, 37, 37, 38, 38, 36, 39, 40,
            40, 41, 41, 39, 42, 43, 43, 44, 44, 42, 45, 46, 46, 47, 47, 45 };
...
// That the case where instances need to be consolidated, but split into multiple cells / merged
// meshes.
TEST(Consolidation, ConsolidateInstancesSplit)
{
    ...
    consolidationConfig.strategy = HdMaxConsolidator::Strategy::Static;
    consolidationConfig.maxTriangles = 100;
    // Scene is 4 instances of pyramids composed of 4 triangles, so 16 total. With a max cell size
    // of 8, the instances should be split over 2 consolidation cells.
    ...
    // 4 instances, consolidated into 2 meshes (2 cells)... so 4 render items 2 for shaded, 2 for
    // wireframe.
...
TEST(Consolidation, Consolidate10Objects4Materials)
{
    ...
    // There are 10 objects in the scene, but only 4 different materials. One of the materials is
    // used by a single object
    ASSERT_EQ(4, renderItems.GetNumberOfRenderItems());

    // Check that the resulting meshes are of expected sizes (order is non-deterministic, because we
    // key off material handles)
    std::unordered_set<int> expectedPointSizes = { 48, 96, 72, 24 };
    std::unordered_set<int> found = {};

    for (int i = 0; i < 4; i++) {
        const auto& shadedRenderItem = renderItems.GetRenderItem(i);
        // The last render item is not consolidated as it is a single mesh, so we expect a decorated
        // render item (with an offset transform).
...
TEST(Consolidation, MaxInstanceCountSizeOption)
{
    ...
    // which will be null here in the case of instances.
...
TEST(Consolidation, StaticStrategyOnStaticData)
{
    ...
    // Render at time code 1 -> nothing has changed in the scene as it is not animated -> the
    // consolidation should still be valid/used even though we are in static mode.
    TestRender(
        stage,
        testEngine,
        renderItems,
...
TEST(Consolidation, DynamicStrategy)
{
...

    {
        ...
        std::array<Point3, 40> expectedPoints
            = { Point3(-22.412651, -2.047300, 0.000000),  Point3(-22.412651, -13.864553, 0.000000),
                Point3(-10.205800, -13.864553, 0.000000), Point3(-10.205800, -2.047300, 0.000000),
                Point3(-10.205800, -2.047300, 0.000000),  Point3(-10.205800, -13.864553, 0.000000),
                Point3(2.001050, -13.864553, 0.000000),   Point3(2.001050, -2.047300, 0.000000),
                Point3(-22.412651, 9.769953, 0.000000),   Point3(-22.412651, -2.047300, 0.000000),
                Point3(-10.205800, -2.047300, 0.000000),  Point3(-10.205800, 9.769953, 0.000000),
                Point3(-10.205800, 9.769953, 0.000000),   Point3(-10.205800, -2.047300, 0.000000),
                Point3(2.001050, -2.047300, 0.000000),    Point3(2.001050, 9.769953, 0.000000),
                Point3(15.351128, -10.598882, 15.736800), Point3(21.728214, -17.094683, 11.861380),
                Point3(24.061899, -2.047300, 15.736800),  Point3(30.438984, -8.543102, 11.861380),
                Point3(24.061899, -2.047300, 15.736800),  Point3(21.728214, -17.094683, 11.861380),
                Point3(24.061899, -2.047300, 15.736800),  Point3(30.438984, -8.543102, 11.861380),
                Point3(32.772671, 6.504281, 15.736800),   Point3(39.149757, 0.008479, 11.861380),
                Point3(32.772671, 6.504281, 15.736800),   Point3(30.438984, -8.543102, 11.861380),
                Point3(8.974042, -4.103080, 19.612221),   Point3(15.351128, -10.598882, 15.736800),
                Point3(17.684814, 4.448502, 19.612221),   Point3(24.061899, -2.047300, 15.736800),
                Point3(17.684814, 4.448502, 19.612221),   Point3(15.351128, -10.598882, 15.736800),
                Point3(17.684814, 4.448502, 19.612221),   Point3(24.061899, -2.047300, 15.736800),
                Point3(26.395584, 13.000083, 19.612221),  Point3(32.772671, 6.504281, 15.736800),
                Point3(26.395584, 13.000083, 19.612221),  Point3(24.061899, -2.047300, 15.736800) };
        EXPECT_TRUE(Point3ArraysAreAlmostEqual(
            expectedPoints.data(),
            static_cast<int>(expectedPoints.size()),
            pointsData,
...

    {
        ...
        std::array<Point3, 40> expectedNormals = { Point3(0.00000000, 0.00000000, 1.00000000),
                                                   Point3(0.00000000, 0.00000000, 1.00000000),
                                                   Point3(0.00000000, 0.00000000, 1.00000000),
                                                   Point3(0.00000000, 0.00000000, 1.00000000),
                                                   Point3(0.00000000, 0.00000000, 1.00000000),
                                                   Point3(0.00000000, 0.00000000, 1.00000000),
...

    {
        ...
        std::array<Point3, 40> expectedUvs
            = { Point3(0.000000, 0.500000, 0.000000), Point3(0.000000, 1.000000, 0.000000),
                Point3(0.500000, 1.000000, 0.000000), Point3(0.500000, 0.500000, 0.000000),
                Point3(0.500000, 0.500000, 0.000000), Point3(0.500000, 1.000000, 0.000000),
                Point3(1.000000, 1.000000, 0.000000), Point3(1.000000, 0.500000, 0.000000),
                Point3(0.000000, 0.000000, 0.000000), Point3(0.000000, 0.500000, 0.000000),
                Point3(0.500000, 0.500000, 0.000000), Point3(0.500000, 0.000000, 0.000000),
                Point3(0.500000, 0.000000, 0.000000), Point3(0.500000, 0.500000, 0.000000),
                Point3(1.000000, 0.500000, 0.000000), Point3(1.000000, 0.000000, 0.000000),
                Point3(0.000000, 1.260000, 0.000000), Point3(0.000000, 1.000000, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.960000, 1.000000, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.000000, 1.000000, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.960000, 1.000000, 0.000000),
                Point3(1.920000, 1.260000, 0.000000), Point3(1.919999, 1.000000, 0.000000),
                Point3(1.920000, 1.260000, 0.000000), Point3(0.960000, 1.000000, 0.000000),
                Point3(0.000001, 1.520000, 0.000000), Point3(0.000000, 1.260000, 0.000000),
                Point3(0.960000, 1.520000, 0.000000), Point3(0.960000, 1.260000, 0.000000),
                Point3(0.960000, 1.520000, 0.000000), Point3(0.000000, 1.260000, 0.000000),
                Point3(0.960000, 1.520000, 0.000000), Point3(0.960000, 1.260000, 0.000000),
                Point3(1.920000, 1.520000, 0.000000), Point3(1.920000, 1.260000, 0.000000),
                Point3(1.920000, 1.520000, 0.000000), Point3(0.960000, 1.260000, 0.000000) };
        EXPECT_TRUE(Point3ArraysAreAlmostEqual(
            expectedUvs.data(),
            static_cast<int>(expectedUvs.size()),
            uvData,
            static_cast<int>(uvBuffer.GetNumberOfVertices())));
        uvBuffer.Unlock();
    }
...

    {
        ...
        std::array<Point3, 40> expectedPoints
            = { Point3(-22.412651, -2.047300, 0.000000),  Point3(-22.412651, -13.864553, 0.000000),
                ...
                Point3(-10.205800, 9.769953, 0.000000),   Point3(-10.205800, -2.047300, 0.000000),
                Point3(2.001050, -2.047300, 0.000000),    Point3(2.001050, 9.769953, 0.000000),
                Point3(20.388432, -0.029459, 17.045118),  Point3(18.441692, -2.428929, 15.279857),
                Point3(24.061899, -2.047300, 15.736800),  Point3(22.115160, -4.446770, 13.971539),
                Point3(24.061899, -2.047300, 15.736800),  Point3(18.441692, -2.428929, 15.279857),
                Point3(24.061899, -2.047300, 15.736800),  Point3(22.115160, -4.446770, 13.971539),
                Point3(27.735367, -4.065141, 14.428482),  Point3(25.788630, -6.464611, 12.663221),
                Point3(27.735367, -4.065141, 14.428482),  Point3(22.115160, -4.446770, 13.971539),
                Point3(22.335169, 2.370011, 18.810379),   Point3(20.388432, -0.029459, 17.045118),
                Point3(26.008638, 0.352170, 17.502062),   Point3(24.061899, -2.047300, 15.736800),
                Point3(26.008638, 0.352170, 17.502062),   Point3(20.388432, -0.029459, 17.045118),
                Point3(26.008638, 0.352170, 17.502062),   Point3(24.061899, -2.047300, 15.736800),
                Point3(29.682106, -1.665672, 16.193743),  Point3(27.735367, -4.065141, 14.428482),
                Point3(29.682106, -1.665672, 16.193743),  Point3(24.061899, -2.047300, 15.736800) };
        EXPECT_TRUE(Point3ArraysAreAlmostEqual(
            expectedPoints.data(),
            static_cast<int>(expectedPoints.size()),
            pointsData,
...

    {
        ...
        std::array<Point3, 40> expectedUvs
            = { Point3(0.000000, 0.500000, 0.000000), Point3(0.000000, 1.000000, 0.000000),
                ...
                Point3(0.500000, 0.000000, 0.000000), Point3(0.500000, 0.500000, 0.000000),
                Point3(1.000000, 0.500000, 0.000000), Point3(1.000000, 0.000000, 0.000000),
                Point3(0.624336, 1.260000, 0.000000), Point3(0.624336, 1.351873, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.960000, 1.351873, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.624336, 1.351873, 0.000000),
                Point3(0.960000, 1.260000, 0.000000), Point3(0.960000, 1.351873, 0.000000),
                Point3(1.295664, 1.260000, 0.000000), Point3(1.295664, 1.351873, 0.000000),
                Point3(1.295664, 1.260000, 0.000000), Point3(0.960000, 1.351873, 0.000000),
                Point3(0.624336, 1.168127, 0.000000), Point3(0.624336, 1.260000, 0.000000),
                Point3(0.960000, 1.168127, 0.000000), Point3(0.960000, 1.260000, 0.000000),
                Point3(0.960000, 1.168127, 0.000000), Point3(0.624336, 1.260000, 0.000000),
                Point3(0.960000, 1.168127, 0.000000), Point3(0.960000, 1.260000, 0.000000),
                Point3(1.295664, 1.168127, 0.000000), Point3(1.295664, 1.260000, 0.000000),
                Point3(1.295664, 1.168127, 0.000000), Point3(0.960000, 1.260000, 0.000000) };
        EXPECT_TRUE(Point3ArraysAreAlmostEqual(
            expectedUvs.data(),
            static_cast<int>(expectedUvs.size()),
            uvData,
...
TEST(Consolidation, BreakingModificationsPrimChanges)
{
    ...
    for (int i = 0; i < int(HdMaxConsolidator::Strategy::Off); ++i) {
        ...
        auto       sphere1 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomXformable>(
            stage, pxr::SdfPath("/sphere1"), pxr::TfToken("Sphere"));
        auto cube1 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomXformable>(
            stage, pxr::SdfPath("/cube1"), pxr::TfToken("Cube"));
        ...
        auto cone1 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomXformable>(
            stage, pxr::SdfPath("/cone1"), pxr::TfToken("Cone"));
        auto cone2 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomXformable>(
            stage, pxr::SdfPath("/cone2"), pxr::TfToken("Cone"));
        TestRender(
            stage,
            testEngine,
            renderItems,
        ...
        // Hide the first sphere... should start over the consolidation, so we get one consolidated
        // mesh with both cones and the cube.
        ...
        // Hide everything expect one of the cones...only a single prim left, shouldnt be
        // consolidated
...
TEST(Consolidation, BreakingModificationsMaterialChanges)
{
    ...
    for (int i = 0; i < int(HdMaxConsolidator::Strategy::Off); ++i) {
        ...
        const auto stage = pxr::UsdStage::CreateInMemory();
        auto       cube1 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomCube>(
            stage, pxr::SdfPath("/cube1"), pxr::TfToken("Cube"));
        auto cube2 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomCube>(
            stage, pxr::SdfPath("/cube2"), pxr::TfToken("Cube"));
        ...
        // Add a third cube, sharing the same color/material as cube1...they should get
        // consolidated.
        auto cube3 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomCube>(
            stage, pxr::SdfPath("/cube3"), pxr::TfToken("Cube"));
        ...
        auto cone1 = MaxUsd::FetchOrCreatePrim<pxr::UsdGeomCone>(
            stage, pxr::SdfPath("/cone"), pxr::TfToken("Cone"));
        ...
        EXPECT_EQ(
            42,
            GetTriCount(
                renderItems.GetRenderItem(0), false)); // cube1 + cone1 - green - consolidated
        EXPECT_EQ(
            12,
            GetTriCount(
                renderItems.GetRenderItem(1), true)); // cube2 / default color unconsolidated
        EXPECT_EQ(
            12, GetTriCount(renderItems.GetRenderItem(2), true)); // cube3 / blue / unconsolidated
        renderItems.ClearAllRenderItems();
    }
}
...
TEST(Consolidation, BreakingModificationsInstancer)
{
    ...
    for (int i = 0; i < int(HdMaxConsolidator::Strategy::Off); ++i) {
        ...
        // File has a point instancer, 2 protos (cone and cube), with animated transforms (and
        // count).

        // Between timecode 0 and 1, only transforms are animated. Use the bounding box of the
        // resulting consolidation To validate the new transform is taken into account. Then,
        // between 1 and 2, more instances are added for each prototype.
        ...
        // Time code 2 - more instances added. Test that we get expected consolidated mesh size and
        // bboxes. Order is non deterministic so use a map.
        std::map<int, Box3> expectedSizeAndBbox;
        expectedSizeAndBbox.insert({ 24, Box3 { { -1.f, -1.f, 0.f }, { 11.f, 11.f, 11.f } } });
        expectedSizeAndBbox.insert(
            { 90, Box3 { { -1.f, 1.54900002f, 0.f }, { 6.f, 5.95100021f, 11.5f } } });
        ...
        TestRender(
            ...
            consolidationConfig);
        EXPECT_EQ(2, renderItems.GetNumberOfRenderItems());
        actualSizeAndBbox.insert({ GetTriCount(renderItems.GetRenderItem(0), false),
                                   GetBoundingBox(renderItems.GetRenderItem(0), false) });
...
TEST(Consolidation, Disabled)
{
    ...
    TestRender(
        ...
        { pxr::HdReprTokens->smoothHull },
        consolidationConfig);
    EXPECT_EQ(10, renderItems.GetNumberOfRenderItems()); // All then objects are expected, as
...
TEST(Consolidation, Consolidate2BoxesWithBadPrimvarIndices)
{
    ...
    std::array<Point3, 48> expectedNormals
        = { Point3(0.000000, 0.000000, -1.000000),   Point3(0.000000, 0.000000, -1.000000),
            Point3(0.000000, 0.000000, -1.000000),   Point3(0.000000, 0.000000, -1.000000),
            Point3(0.000000, 0.000000, 1.000000),    Point3(0.000000, 0.000000, 1.000000),
            Point3(0.000000, 0.000000, 1.000000),    Point3(0.000000, 0.000000, 0.000000),
            Point3(0.000000, -1.000000, 0.000000),   Point3(0.000000, -1.000000, 0.000000),
            Point3(0.000000, -1.000000, 0.000000),   Point3(0.000000, -1.000000, 0.000000),
            Point3(1.000000, 0.000000, 0.000000),    Point3(1.000000, 0.000000, 0.000000),
            Point3(1.000000, 0.000000, 0.000000),    Point3(1.000000, 0.000000, 0.000000),
...
TEST(Consolidation, PartialSubsetsConsolidation)
{
    ...
    EXPECT_EQ(
        30, box1TrianglesIndexBuffer.GetNumberOfIndices()); // 5 quads -> 10 tris -> 30 indices.
    ...
    EXPECT_EQ(
        30, box2TrianglesIndexBuffer.GetNumberOfIndices()); // 5 quads -> 10 tris -> 30 indices.
}

// We had an issue when only part of a mesh's subsets were being consolidated - because vertex
// buffers are shared across the subsets - we were only looking at the first subset's dirty state
// when deciding to load the geometry into nitrous buffers. However, considering consolidation, it
// is possible for subsets to have different dirty states. If the first subsets was being
// consolidated, then we would never load the buffers, even though they were required by other
// subsets. Now, we load the buffers if required by any of the subsets. The following test makes
// sure this is done.
...
TEST(Consolidation, GeomSubsetInstanceSplit)
{
    ...
    consolidationConfig.maxCellSize = 11; // All subsets have the same material, considered
                                          // together, not enough space in a cell. No consolidation.
    TestRender(
        stage,
        testEngine,
        renderItems,
    ...
    // No consolidation can happen, end up with on render item per subset (instanced render items,
    // containing 6 instances each)
...
// Testing that instances with subsets, which share materials with non-instanced geometry in the
// scene, get consolidated correctly.
