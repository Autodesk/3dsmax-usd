...
public:
	...
	*/
	...
	RefResult NotifyRefChanged(const Interval& /*changeInt*/, RefTargetHandle /*hTarget*/, PartID& /*partID*/, RefMessage /*message*/, BOOL /*propagate*/) override { return REF_FAIL; }
...
public:
	...
	Class_ID ClassID() override {
		return Class_ID(MULTI_CLASS_ID, 0x00000000);
	}
	...
	void GetSubMtlName(int mtlid, MSTR& s) override {
		s = names[mtlid];
	}
