...
public:
	...
	int GetAssetDirCount(MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return 0; }
	const MCHAR* GetAssetDir(int /*i*/, MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return nullptr; }
	bool AddAssetDir(const MCHAR* /*dir*/, MaxSDK::AssetManagement::AssetType /*assetType*/) override { return false; }
	bool AddAssetDir(const MCHAR* /*dir*/, MaxSDK::AssetManagement::AssetType /*assetType*/, int /*update*/) override { return false; }
	bool DeleteAssetDir(int /*i*/, MaxSDK::AssetManagement::AssetType /*assetType*/, int /*update*/) override { return false; }
	bool AddSessionAssetDir(const MCHAR* /*dir*/, MaxSDK::AssetManagement::AssetType /*assetType*/, int /*update*/) override { return false; }
	int GetSessionAssetDirCount(MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return 0; }
	const MCHAR* GetSessionAssetDir(int /*i*/, MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return nullptr; }
	bool DeleteSessionAssetDir(int /*i*/, MaxSDK::AssetManagement::AssetType /*assetType*/, int /*update*/) override { return false; }
	int GetCurAssetDirCount(MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return 0; }
	const MCHAR* GetCurAssetDir(int /*i*/, MaxSDK::AssetManagement::AssetType /*assetType*/) const override { return nullptr; }
	...
	const MaxSDK::Util::Path& GetCurrentProjectFolder() const override { static MaxSDK::Util::Path path; return path; }
	bool SetCurrentProjectFolder(const MaxSDK::Util::Path& /*aDirectory*/) override { return false; }
	bool SetSessionProjectFolder(const MaxSDK::Util::Path& /*aDirectory*/) override { return false; }
	bool DoProjectSetupSteps() const override { return false; }
	bool DoProjectSetupStepsUsingDirectory(const MaxSDK::Util::Path& /*aDirectory*/) const override { return false; }
	bool IsProjectFolder(const MaxSDK::Util::Path& /*aDirectoryToCheck*/) const override { return false; }
	MaxSDK::Util::Path GetProjectFolderPath(const MaxSDK::Util::Path& /*aProjectRoot*/) const override { return nullptr; }
	...
	bool CreateDirectoryHierarchy(const MaxSDK::Util::Path& /*aPath*/) const override { return false; }
	...
	void RecordInputAsset(const MaxSDK::AssetManagement::AssetUser& /*originalPath*/, AssetEnumCallback& /*nameEnum*/, DWORD /*vflags*/) const override {}
	void RecordOutputAsset(const MaxSDK::AssetManagement::AssetUser& /*originalAsset*/, AssetEnumCallback& /*nameEnum*/, DWORD /*vflags*/) const override {}
