...
public:
     ...
     * side-effects.
     */
    FPStatus Invoke(FunctionID /*fid*/, TimeValue /*t*/ = 0, FPParams* /*params*/ = NULL)
    {
        return 0;
    }
    FPStatus Invoke(FunctionID /*fid*/, FPParams* /*params*/ = NULL) { return 0; }
    FPStatus
    Invoke(FunctionID /*fid*/, TimeValue /*t*/, FPValue& /*result*/, FPParams* /*params*/ = NULL)
    {
        return 0;
    }
    FPStatus Invoke(FunctionID /*fid*/, FPValue& /*result*/, FPParams* /*params*/ = NULL)
    {
        return 0;
    }
