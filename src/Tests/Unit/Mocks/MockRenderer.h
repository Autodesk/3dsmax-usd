...
public:
	 ...
	 */
	int Open(INode* /*scene*/, INode* /*vnode*/, ViewParams* /*viewPar*/, RendParams &/*rp*/, HWND /*hwnd*/, DefaultLight* /*defaultLights*/ = NULL, int /*numDefLights*/ = 0, RendProgressCallback* /*prog*/ = NULL) { return 0; }
	int Render(TimeValue /*t*/, Bitmap* /*tobm*/, FrameRendParams& /*frp*/, HWND /*hwnd*/, RendProgressCallback* /*prog*/ = NULL, ViewParams* /*viewPar*/ = NULL) { return 0; }
	void Close(HWND /*hwnd*/, RendProgressCallback* /*prog*/ = NULL) { }
	bool ApplyRenderEffects(TimeValue /*t*/, Bitmap* /*pBitmap*/, bool /*updateDisplay*/ = true) { return false; }
	...
	enum Requirement { kRequirement_NoPauseSupport = 0, kRequirement_NoVFB = 1, kRequirement_DontSaveRenderOutput = 2, kRequirement_Wants32bitFPOutput = 3, kRequirement_WantsObjectSelection = 4, kRequirement_NoGBufferForToneOpPreview = 5, kRequirement_SupportsConcurrentRendering = 6 };
