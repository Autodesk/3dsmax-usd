...
public:
	...
	Point3 SnapPoint(const IPoint2& /*in*/, IPoint2& /*out*/, Matrix3* /*plane2d*/ = NULL, DWORD /*flags*/ = 0) override { return nullptr; }
	void SnapPreview(const IPoint2& /*in*/, IPoint2& /*out*/, Matrix3* /*plane2d*/ = NULL, DWORD /*flags*/ = 0) override {}
	void GetGridDims(float* /*MinX*/, float* /*MaxX*/, float* /*MinY*/, float* /*MaxY*/) override {}
	float SnapLength(float /*in*/) override { return 0.0f; }
	float GetCPDisp(const Point3 /*base*/, const Point3& /*dir*/, const IPoint2& /*sp1*/, const IPoint2& /*sp2*/, BOOL /*snap*/ = FALSE) override { return 0.0f; }
	...
	void LogHit(INode* /*nr*/, ModContext* /*mc*/, DWORD /*dist*/, ulong /*info*/, HitData* /*hitdata*/ = NULL) override {}
	...
	void TrackImplicitGrid(IPoint2 /*m*/, Matrix3* /*mat*/ = NULL, ULONG /*hitTestFlags*/ = 0) override {}
