...
{
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::TexCoord2fArray),
        pxr::SdfValueTypeNames->TexCoord2fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::TexCoord3fArray),
        pxr::SdfValueTypeNames->TexCoord3fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::FloatArray),
        pxr::SdfValueTypeNames->FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::Float2Array),
        pxr::SdfValueTypeNames->Float2Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::Float3Array),
        pxr::SdfValueTypeNames->Float3Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type::Color3fArray),
        pxr::SdfValueTypeNames->Color3fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetValueTypeName(MappedAttributeBuilder::Type(-1)),
        pxr::SdfValueTypeNames->Float3Array);
}
...
{
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::TexCoord2fArray), 2);
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::TexCoord3fArray), 3);
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::FloatArray), 1);
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::Float2Array), 2);
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::Float3Array), 3);
    EXPECT_EQ(
        MappedAttributeBuilder::GetTypeDimension(MappedAttributeBuilder::Type::Color3fArray), 3);
...
{
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::FloatArray, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::FloatArray, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::FloatArray, 2),
        MappedAttributeBuilder::Type::Float2Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::FloatArray, 3),
        MappedAttributeBuilder::Type::Float3Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::FloatArray, 4),
        MappedAttributeBuilder::Type::Float3Array);

    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float2Array, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float2Array, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float2Array, 2),
        MappedAttributeBuilder::Type::Float2Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float2Array, 3),
        MappedAttributeBuilder::Type::Float3Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float2Array, 4),
        MappedAttributeBuilder::Type::Float3Array);

    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float3Array, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float3Array, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float3Array, 2),
        MappedAttributeBuilder::Type::Float2Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float3Array, 3),
        MappedAttributeBuilder::Type::Float3Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Float3Array, 4),
        MappedAttributeBuilder::Type::Float3Array);

    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(
            MappedAttributeBuilder::Type::TexCoord2fArray, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord2fArray, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord2fArray, 2),
        MappedAttributeBuilder::Type::TexCoord2fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord2fArray, 3),
        MappedAttributeBuilder::Type::TexCoord3fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord2fArray, 4),
        MappedAttributeBuilder::Type::TexCoord3fArray);

    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(
            MappedAttributeBuilder::Type::TexCoord3fArray, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord3fArray, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord3fArray, 2),
        MappedAttributeBuilder::Type::TexCoord2fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord3fArray, 3),
        MappedAttributeBuilder::Type::TexCoord3fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::TexCoord3fArray, 4),
        MappedAttributeBuilder::Type::TexCoord3fArray);

    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Color3fArray, -1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Color3fArray, 1),
        MappedAttributeBuilder::Type::FloatArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Color3fArray, 2),
        MappedAttributeBuilder::Type::Float2Array);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Color3fArray, 3),
        MappedAttributeBuilder::Type::Color3fArray);
    EXPECT_EQ(
        MappedAttributeBuilder::GetEquivalentType(MappedAttributeBuilder::Type::Color3fArray, 4),
        MappedAttributeBuilder::Type::Color3fArray);
}
...
TEST(MappedAttributeBuilderTests, ConstantPrimvar)
{
    ...
    MappedAttributeBuilder::Config config { pxr::TfToken("testPrimvar"),
                                            MappedAttributeBuilder::Type::Float3Array };
...
TEST(MappedAttributeBuilderTests, VertexPrimvar_Indexed)
{
    ...
    float               nextValue = 0.f;
    std::generate(
        values.begin(), values.end(), [&nextValue]() { return Point3(nextValue++, 0.f, 0.f); });
    ...
    for (int i = 0; i < cube.FNum(); i++) {
        ...
        for (int j = 0; j < face->deg; j++) {
            ...
            (*faceDataIndices)[faceVertex++]
                = vertexIndex % 2; // even/odd vertices share the same data
        }
    }
    ...
    MappedAttributeBuilder primvarBuilder(
        ...
        std::make_shared<MappedAttributeBuilder::MappedData>(
            values.data(), values.size(), faceDataIndices));
    MappedAttributeBuilder::Config config { pxr::TfToken("testPrimvar"),
                                            MappedAttributeBuilder::Type::Float3Array };
    primvarBuilder.BuildPrimvar(usdMesh, config, pxr::UsdTimeCode::Default(), false);

    auto primvar = pxr::UsdGeomPrimvarsAPI(usdMesh.GetPrim())
                       .GetPrimvar(pxr::TfToken(config.GetPrimvarName()));
...
void VertexPrimvar_Test(bool ordered)
{
    ...
    float               nextValue = 0.f;
    // All values are different. One piece of data per vertex, we can avoid an index by using the
    // same order as vertices (as if the indexing was [0,1,2,3,4,5,7].
    std::generate(
        values.begin(), values.end(), [&nextValue]() { return Point3(nextValue++, 0.f, 0.f); });
    ...
    // Test simple case, data is already in the same order as the vertices (i.e. vertex indices ==
    // data indices)
    if (ordered) {
    ...
    // Data is ordered differently, but the count is the same so it can just be reordered to avoid
    ...
    for (int i = 0; i < primvarValues.size(); i++) {
        EXPECT_EQ(
            primvarValues[i],
            pxr::GfVec3f(expectedDataArray[i].x, expectedDataArray[i].y, expectedDataArray[i].z));
    }
...
TEST(MappedAttributeBuilderTests, VertexPrimvar_Ordered) { VertexPrimvar_Test(true); }

TEST(MappedAttributeBuilderTests, VertexPrimvar_Unordered) { VertexPrimvar_Test(false); }
...
TEST(MappedAttributeBuilderTests, FaceVaryingPrimvarIndexed)
{
    ...
    // The first face-vertex uses values[0], all others values[1]. This means one of the corners of
    // the cube will not have all its face-vertices pointing to the same data.
    ...
    EXPECT_TRUE(std::all_of(
        primvarIndices.begin() + 1, primvarIndices.end(), [](int idx) { return idx == 1; }));
...
void FaceVaryingPrimvar_Test(bool ordered)
{
    ...
    auto faceDataIndices = std::make_shared<std::vector<int>>(24);
    // As long as we have 24 values, i.e. one piece of data for each face-vertex on the cube, we
    // should not need indexing. We just need to make sure the data is reordered if the order on
    // data indices doesn't match the order in face indices. If testing unordered, go in reverse
    // order.
    ...
    for (int i = ordered ? 0 : int(faceDataIndices->size()) - 1; i < primvarValues.size();
         i += increment) {
        EXPECT_EQ(primvarValues[i], pxr::GfVec3f(values[i].x, values[i].y, values[i].z));
    }
...
TEST(MappedAttributeBuilderTests, FaceVaryingPrimvar_Ordered) { FaceVaryingPrimvar_Test(true); }

TEST(MappedAttributeBuilderTests, FaceVaryingPrimvar_Unordered) { FaceVaryingPrimvar_Test(false); }
...
TEST(MappedAttributeBuilderTests, PrimvarExportDimensions)
{
    ...
    {
        MappedAttributeBuilder::Config config { pxr::TfToken("float1"),
                                                MappedAttributeBuilder::Type::FloatArray,
                                                false };
        primvarBuilder.BuildPrimvar(usdMesh, config, pxr::UsdTimeCode::Default(), false);
        const auto primvar1 = pxr::UsdGeomPrimvarsAPI(usdMesh.GetPrim())
                                  .GetPrimvar(pxr::TfToken(config.GetPrimvarName()));
    ...
    {
        MappedAttributeBuilder::Config config { pxr::TfToken("float2"),
                                                MappedAttributeBuilder::Type::Float2Array,
                                                false };
        primvarBuilder.BuildPrimvar(usdMesh, config, pxr::UsdTimeCode::Default(), false);
        const auto primvar2 = pxr::UsdGeomPrimvarsAPI(usdMesh.GetPrim())
                                  .GetPrimvar(pxr::TfToken(config.GetPrimvarName()));
    ...
    {
        MappedAttributeBuilder::Config config { pxr::TfToken("float3"),
                                                MappedAttributeBuilder::Type::Float3Array,
                                                false };
        primvarBuilder.BuildPrimvar(usdMesh, config, pxr::UsdTimeCode::Default(), false);
        const auto primvar3 = pxr::UsdGeomPrimvarsAPI(usdMesh.GetPrim())
                                  .GetPrimvar(pxr::TfToken(config.GetPrimvarName()));
...
TEST(MappedAttributeBuilderTests, BuildMappedAttributeAtTimeCode)
{
    ...
    // Sets up the primvar indices and values on the usdMesh at a specific timecode, using a primvar
    // builder..
    auto setupPrimvarAtTimeCode = [&config, &quad, &usdMesh](
                                      const std::vector<int>&    indices,
                                      const std::vector<Point3>& values,
                                      const pxr::UsdTimeCode&    timeCode) {
        const MappedAttributeBuilder primvarBuilder(
    ...
    // Make sure to use different indices/values at each timecode, to be certain we are not
    // validating against interpolated values later.
    setupPrimvarAtTimeCode(
        std::vector<int> { 0, 1, 0, 1 },
        std::vector<Point3> { Point3(0.f, 0.f, 0.f), Point3(1.f, 1.f, 1.f) },
        pxr::UsdTimeCode::Default());
    setupPrimvarAtTimeCode(
        std::vector<int> { 1, 1, 0, 0 },
        std::vector<Point3> { Point3(2.f, 2.f, 2.f), Point3(3.f, 3.f, 3.f) },
        pxr::UsdTimeCode(1));
    setupPrimvarAtTimeCode(
        std::vector<int> { 0, 0, 1, 1 },
        std::vector<Point3> { Point3(4.f, 4.f, 4.f), Point3(5.f, 5.f, 5.f) },
        pxr::UsdTimeCode(2));
...
TEST(MappedAttributeBuilderTests, VertexPrimvar_UnusedVertices)
{
    ...
    const MappedAttributeBuilder primvarBuilder(
        MaxUsd::MeshFacade { &meshWithUnusedVerts },
        std::make_shared<MappedAttributeBuilder::MappedData>(
            mappedValues.data(),
            2,
