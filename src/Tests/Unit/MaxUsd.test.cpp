...
TEST(MaxUsdTest, IsValidAbsolutePath)
{
	...
	EXPECT_TRUE(MaxUsd::IsValidAbsolutePath(L"C:/./././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././././not.txt"));
	// Path too long.
	EXPECT_FALSE(MaxUsd::IsValidAbsolutePath(L"C:.txt"));
	// Not a file.
