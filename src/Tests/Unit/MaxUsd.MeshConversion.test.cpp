...
TEST(MeshConversionTest, NonPlanarFaceToUsd)
{
	...
	std::map<MtlID, pxr::VtIntArray> materialIdToFacesMap;
	MaxUsd::MeshConverter::ObjectChannelIntervals intervals;
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{ &nonPlanarFaceMesh }, stage, path, options, usdMesh, pxr::UsdTimeCode::Default(), materialIdToFacesMap, false, intervals);
...
TEST(MeshConversionTest, LeftHandedFaceOrientation)
{
	...
	std::map<int, std::string> channelNames;
	converter.ConvertToMNMesh(usdMesh, reconvertedQuad, MaxUsd::PrimvarMappingOptions{}, channelNames);
...
TEST(MeshConversionTest, PreserveEdgeOrientation)
{
	...
	MaxUsd::MeshConverter::ObjectChannelIntervals intervals;
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{&plane}, stage, path, options, usdMeshDontPreserve, pxr::UsdTimeCode::Default(), materialIdToFacesMap, false, intervals);
	...
	options.SetPreserveEdgeOrientation(true);
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{&plane}, stage, path, options, usdMeshPreserve, pxr::UsdTimeCode::Default(), materialIdToFacesMap, false, intervals);

	// Compare result when preserving (some faces will have triangulated, creating more faces and vertices on exported mesh)
...
TEST(MeshConversionTest, TimeSampledUsdMesh)
{
	...
	auto setupAtTimeCode = [&](const pxr::VtVec3fArray& points, const pxr::VtIntArray& faceCounts, const pxr::VtIntArray& indices, const pxr::UsdTimeCode& timeCode)
	{
	...
	// Default timeCode.
	const pxr::VtVec3fArray pointsDefault = { {0.f, 0.f, 0.f}, {0.f, 1.f, 0.f} , {0.f, 0.f, 1.f} };
	...
	// TimeCode 1.
	const pxr::VtVec3fArray points1 = { {0.f, 0.f, 0.f}, {0.f, 1.f, 0.f} , {0.f, 0.f, 1.f}, {0.f, 1.f, 1.f} };
	...
	// TimeCode 2.
	const pxr::VtVec3fArray points2 = { {0.f, 0.f, 0.f}, {0.f, 1.f, 0.f} , {0.f, 0.f, 1.f}, {0.f, 1.f, 1.f}, {0.f, 1.f, 2.f} };
	...
	auto testAtTimeCode = [&](const pxr::VtVec3fArray& points, const pxr::VtIntArray& faceCounts, const pxr::VtIntArray& indices, const pxr::UsdTimeCode& timeCode)
	{
		MNMesh maxMesh;
		MaxUsd::MeshConverter converter;
		std::map<int, std::string> channelNames;
...
TEST(MeshConversionTest, ConvertMaxMeshToUsdTimeCode)
{
	...
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{&quad}, stage, path, options, usdMesh, pxr::UsdTimeCode::Default(), materialIdToFacesMap, false, intervals);
	// TimeCode 1
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{&roof}, stage, path, options, usdMesh, pxr::UsdTimeCode(1), materialIdToFacesMap, false, intervals);
	// TimeCode 2
	converter.ConvertToUSDMesh(MaxUsd::MeshFacade{&cube}, stage, path, options, usdMesh, pxr::UsdTimeCode(2), materialIdToFacesMap, false, intervals);
	...
	const pxr::VtIntArray expectedfaceIndices3 = { 0, 2, 3, 1, 4, 5, 7, 6, 0, 1, 5, 4, 1, 3, 7, 5, 3, 2, 6, 7, 2, 0, 4,
		6 };
